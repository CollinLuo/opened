...
define('MIN_CACHE_DIR', $_SERVER['DOCUMENT_ROOT'] . $webPath. "/Application/Runtime/Cache/MinFiles/");

//$file = fopen("ajax_min.txt","w");
//fwrite($file,$webPath);
//fwrite($file,APP_PATH);
//fwrite($file,MIN_CACHE_DIR);
//fclose($file);
