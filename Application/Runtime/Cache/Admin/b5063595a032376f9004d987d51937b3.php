			...
			<!-- End .content-box-header -->
      		<div class="content-box-content">
				...
				<div class="tab-content default-tab" id="tab1">
					<?php if($act == 'mtrash'): ?><form action="<?php echo U('File/mTrash');?>" method="post" name="business_form">
					<?php else: ?>
					<form action="<?php echo U('File/index');?>" method="post" name="business_form"><?php endif; ?>
								...
								<tr>
									<td>
										<div class="explain-col">
											<span>输入要查找的业务名称:&nbsp;<input name="keyword" type="text" style="width:140px;"  value="<?php echo ($keyword); ?>" />&nbsp;&nbsp;</span>&nbsp;&nbsp;
											<span><input type="submit" class="button" value="搜索业务"></span>
										</div>
									</td>
								</tr>
							</tbody>
						...
						<table>
							<thead>
								<tr>
									...
									<th align="center" width="14%">业务名称</th>
									<th align="center" width="15%">所属项目</th>
									<th align="center" width="10%">花费</th>
									<th align="center" width="13%">所属上级业务</th>
									<th align="center" width="10%">创建时间</th>
									<th align="center" width="8%">是否激活</th>
									<th align="center" width="10%">完成度</th>
									<th align="center" width="10%">操作</th>
								</tr>
							</thead>
							<tbody>
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "$list_empty" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr align="center" id="tr_project_<?php echo ($val["id"]); ?>" class="{if $val.status eq 0}bg_fuscous{/if}">
									<td align="center"><?php echo ($val["id"]); ?></td>
									<td align="center">
										<input type="checkbox" name="list_checkbox_id[]" value="<?php echo ($val["id"]); ?>">
									</td>
									<td align="center"><?php echo ((isset($val["name"]) && ($val["name"] !== ""))?($val["name"]):"未知业务"); ?></td>
									<td align="center"><?php echo ((isset($val["p_name"]) && ($val["p_name"] !== ""))?($val["p_name"]):"未知项目"); ?></td>
									<td align="center"><?php echo ($val["cost"]); ?></td>
									<td align="center"><?php echo ((isset($val["pb_name"]) && ($val["pb_name"] !== ""))?($val["pb_name"]):"顶级业务"); ?></td>
									...
									<td align="center"><?php echo ($val["completeness"]); ?>%</td>
									<td>
										<!-- Icons -->
										<a href="<?php echo U('Business/mEdit','id='.$val['id']);?>" title="编辑"><img src="/opened/Public/Img/Admin/icons/pencil.png" alt="编辑" /><a href="<?php echo U('Business/mBusinessDetails','id='.$val['id']);?>" title="业务明细管理"><img src="/opened/Public/Img/Admin/icons/user_add.png" alt="业务明细管理" /></a>
									</td>
